...
@XmlRootElement(name="Communion")
public class Communion /*extends Entites*/ {
	...
	@XmlElement(name="idrameau")
	public Long getIdrameau() {
		return idrameau;
	}
	public void setIdrameau(Long idrameau) {
		this.idrameau = idrameau;
	}
